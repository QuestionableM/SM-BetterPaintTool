...
PaintToolGui::t_init_func_sig PaintToolGui::o_initialize = nullptr;

std::uint32_t PaintToolGui::g_paintColors[] =
{
...
void PaintToolGui::requestCoordItem(MyGUI::ItemBox* _sender, MyGUI::IntCoord& _coord, bool _drag)
{
	_coord.left = 0;
	_coord.top = 0;
...
void PaintToolGui::requestCreateWidgetItem(MyGUI::ItemBox* _sender, MyGUI::Widget* _item)
{
...
void PaintToolGui::requestDrawItem(MyGUI::ItemBox* _sender, MyGUI::Widget* _item, const MyGUI::IBDrawItemInfo& _info)
{
...
void PaintToolGui::eventMouseItemActivate(MyGUI::ItemBox* _sender, std::size_t idx)
{
...
void PaintToolGui::eventEditTextChange(MyGUI::EditBox* _sender)
{
...
void PaintToolGui::eventColorMatrixSelectColor(MyGUI::Widget* _sender, int _left, int _top, MyGUI::MouseButton _id)
{
...
void PaintToolGui::eventColorHsvSelectColor(MyGUI::Widget* _sender, int _left, int _top, MyGUI::MouseButton _id)
{
	MyGUI::IntCoord v_sender_sz = _sender->getAbsoluteCoord();
...
void PaintToolGui::colorRScrollChangePosition(MyGUI::ScrollBar* _sender, size_t _position)
{
	this->updateColorSlider("ScrollR");
}

void PaintToolGui::colorGScrollChangePosition(MyGUI::ScrollBar* _sender, size_t _position)
{
	this->updateColorSlider("ScrollG");
}

void PaintToolGui::colorBScrollChangePosition(MyGUI::ScrollBar* _sender, size_t _position)
{
	this->updateColorSlider("ScrollB");
}

void PaintToolGui::eventPresetColorsTabPressed(MyGUI::Widget* _sender, int _left, int _top, MyGUI::MouseButton _id)
{
...
void PaintToolGui::eventCustomColorTabPressed(MyGUI::Widget* _sender, int _left, int _top, MyGUI::MouseButton _id)
{
	if (_sender->castType<MyGUI::Button>()->getStateSelected())
		return;
...
void PaintToolGui::switchTabsAndButtons(bool state)
{
...
void PaintToolGui::getSliderData(MyGUI::Widget* slider_parent, SliderData* p_sliderData)
{
...
Color PaintToolGui::getColorFromSliders()
{
	Color v_color;
...
Color PaintToolGui::getColorFromHsvPicker()
{
...
Color PaintToolGui::getColorPickerColorTransformed(float uv_x, float uv_y, Color col)
{
...
MyGUI::Widget* PaintToolGui::getPresetColorsWnd()
{
	return m_pWidget->findWidget("PresetColorsWnd");
}

MyGUI::Widget* PaintToolGui::getPresetColorsTab()
{
	return m_pWidget->findWidget("PresetColorsTab");
}

MyGUI::Widget* PaintToolGui::getCustomColorWnd()
{
	return m_pWidget->findWidget("CustomColorWnd");
}

MyGUI::Widget* PaintToolGui::getCustomColorTab()
{
	return m_pWidget->findWidget("CustomColorTab");
}

MyGUI::Widget* PaintToolGui::getColorPicker()
{
	return m_pWidget->findWidget("ColorPicker");
}

MyGUI::Widget* PaintToolGui::getColorPickerPointer()
{
	return m_pWidget->findWidget("ColorPickerPointer");
}

MyGUI::Widget* PaintToolGui::getHsvPicker()
{
	return m_pWidget->findWidget("HsvPicker");
}

MyGUI::Widget* PaintToolGui::getHsvPickerPointer()
{
	return m_pWidget->findWidget("HsvPickerPointer");
}

MyGUI::Widget* PaintToolGui::getHexInputBox()
{
	return m_pWidget->findWidget("HexInput");
}

void PaintToolGui::setupColorSlider(
...
void PaintToolGui::updateColorSlider(const std::string& widget_name)
{
	SliderData v_slider;
...
void PaintToolGui::setColorSliderPos(const std::string& widget_name, std::size_t value)
{
...
void PaintToolGui::updateHexValueFromColor(Color col)
{
	char v_buffer[10];
...
void PaintToolGui::updateSlidersFromColor(Color col)
{
...
void PaintToolGui::updateHsvAndColorPickersFromColor(Color col)
{
	float h, s, v;
	RGBtoHSV(col, h, s, v);
...
void PaintToolGui::updateTextureGradient(Color color)
{
...
void PaintToolGui::createTextureGradient()
{
...
void PaintToolGui::createHueGradient()
{
	MyGUI::RenderManager* v_pRendMgr = MyGUI::Singleton<MyGUI::RenderManager>::getInstancePtr();
...
void PaintToolGui::initialize()
{
...

	{
		...
		this->setupColorSlider("ScrollR", "Red", &PaintToolGui::colorRScrollChangePosition);
		this->setupColorSlider("ScrollG", "Green", &PaintToolGui::colorGScrollChangePosition);
		this->setupColorSlider("ScrollB", "Blue", &PaintToolGui::colorBScrollChangePosition);
	}

	{
		...
		v_pEditBox->eventEditTextChange += MyGUI::newDelegate(this, &PaintToolGui::eventEditTextChange);
	}

	{
		...
		v_pBtn->eventMouseButtonPressed += MyGUI::newDelegate(this, &PaintToolGui::eventPresetColorsTabPressed);
	}

	{
		...
		v_pBtn->eventMouseButtonPressed += MyGUI::newDelegate(this, &PaintToolGui::eventCustomColorTabPressed);
	}

	{
		...
		v_pImgBox->eventMouseButtonPressed += MyGUI::newDelegate(this, &PaintToolGui::eventColorMatrixSelectColor);
		v_pImgBox->eventMouseDrag += MyGUI::newDelegate(this, &PaintToolGui::eventColorMatrixSelectColor);
...

	{
		...
		v_pImgBox->setImageCoord(MyGUI::IntCoord(1, 1, 30, 30));
		v_pImgBox->eventMouseButtonPressed += MyGUI::newDelegate(this, &PaintToolGui::eventColorHsvSelectColor);
		v_pImgBox->eventMouseDrag += MyGUI::newDelegate(this, &PaintToolGui::eventColorHsvSelectColor);
	...
	m_pItemBox->requestCoordItem = MyGUI::newDelegate(this, &PaintToolGui::requestCoordItem);
	m_pItemBox->requestCreateWidgetItem = MyGUI::newDelegate(this, &PaintToolGui::requestCreateWidgetItem);
	m_pItemBox->requestDrawItem = MyGUI::newDelegate(this, &PaintToolGui::requestDrawItem);
	m_pItemBox->eventMouseItemActivate += MyGUI::newDelegate(this, &PaintToolGui::eventMouseItemActivate);
...
void PaintToolGui::initParams(PaintTool* paint_tool)
{
	...
	this->switchTabsAndButtons(PaintToolGui::isColorPreset(v_col));
}

void PaintToolGui::h_initialize(PaintToolGui* self)
{
	self->initialize();
}

bool PaintToolGui::isColorPreset(Color col)
{
